...
from hmd_designer_gui_core import hmd_designer_gui_core
...
class StartQT4(QtGui.QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        try:
            self.appCore = hmd_designer_gui_core()
        except RuntimeError:
        ...
        QtCore.QObject.connect(self.ui.buttonVisualizeModel,QtCore.SIGNAL("clicked()"), self.slot_buttonVisualizeModelClicked)
        ...
        QtCore.QObject.connect(self.ui.actionSaveProject,QtCore.SIGNAL("triggered()"), self.slot_actionSaveProjectTriggered)
        ...
        QtCore.QObject.connect(self.ui.spinNumSensors,QtCore.SIGNAL("valueChanged(int)"), self.slot_spinNumSensorsValueChanged)
        QtCore.QObject.connect(self.ui.spinPermutations,QtCore.SIGNAL("valueChanged(int)"), self.slot_spinPermutationsValueChanged)
    ...
    def slot_actionSaveProjectTriggered(self):
        self.appCore.saveProjectFile()
    ...
    def slot_spinNumSensorsValueChanged(self, newValue):
        self.appCore.setNsensors(newValue)
        #print 'slot_spinNumSensorsValueChanged'

    def slot_spinPermutationsValueChanged(self, newValue):
        self.appCore.setPermutations(newValue)
        #print 'slot_spinPermutationsValueChanged'

    def slot_buttonVisualizeModelClicked(self):
        self.appCore.visualizeModel()
